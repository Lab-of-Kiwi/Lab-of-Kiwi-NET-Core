...
public partial class INPUT
{
    public class Url : INPUT
    {
        ...
        {
            get => RawAttributes.GetObject<Attributes.UriParser, Uri>("value");
            set => RawAttributes.SetObject<Attributes.UriParser, Uri>("value", value);
        }

        internal sealed override InputType GetInputType() => InputType.Url;
    }
}
