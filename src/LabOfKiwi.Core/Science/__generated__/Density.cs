...
{
    private static readonly Dimension s_dimension = new(length: -3, mass: 1);
    ...
    public readonly struct Measurement : IMeasurement, IComparable<Measurement>, IEquatable<Measurement>
    {
        ...
        public static Mass.Measurement operator *(Measurement left, Volume.Measurement right) => new(left.Value * right.Value);
        #endregion
    }
}
