...
public static class Frequency
{
    ...
    public readonly struct Measurement : IMeasurement, IComparable<Measurement>, IEquatable<Measurement>
    {
        ...
        public static Time.Measurement operator /(double left, Measurement right) => new(left / right.Value);

        public static ElectricCurrent.Measurement operator *(Measurement left, ElectricCharge.Measurement right) => new(left.Value * right.Value);

        public static Power.Measurement operator *(Measurement left, Energy.Measurement right) => new(left.Value * right.Value);

        public static Speed.Measurement operator *(Measurement left, Length.Measurement right) => new(left.Value * right.Value);

        public static Force.Measurement operator *(Measurement left, Momentum.Measurement right) => new(left.Value * right.Value);

        public static Acceleration.Measurement operator *(Measurement left, Speed.Measurement right) => new(left.Value * right.Value);
        #endregion
    }
}
