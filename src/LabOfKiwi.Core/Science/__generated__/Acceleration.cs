// Code was auto-generated: 6/8/2022 10:15:16 AM
using System;
...
{
    private static readonly Dimension s_dimension = new(time: -2, length: 1);
    ...
    public readonly struct Measurement : IMeasurement, IComparable<Measurement>, IEquatable<Measurement>
    {
        ...
        public static Force.Measurement operator *(Measurement left, Mass.Measurement right) => new(left.Value * right.Value);

        public static Power.Measurement operator *(Measurement left, Momentum.Measurement right) => new(left.Value * right.Value);

        public static Frequency.Measurement operator /(Measurement left, Speed.Measurement right) => new(left.Value / right.Value);
