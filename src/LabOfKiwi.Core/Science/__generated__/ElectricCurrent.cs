...
{
    private static readonly Dimension s_dimension = new(electricCurrent: 1);
    ...
    public readonly struct Measurement : IMeasurement, IComparable<Measurement>, IEquatable<Measurement>
    {
        ...
        public static Frequency.Measurement operator /(Measurement left, ElectricCharge.Measurement right) => new(left.Value / right.Value);

        public static ElectricCharge.Measurement operator /(Measurement left, Frequency.Measurement right) => new(left.Value / right.Value);

        public static ElectricCharge.Measurement operator *(Measurement left, Time.Measurement right) => new(left.Value * right.Value);

        public static Power.Measurement operator *(Measurement left, Voltage.Measurement right) => new(left.Value * right.Value);
        #endregion
    }
}
