...
public static class Pressure
{
    ...
    public readonly struct Measurement : IMeasurement, IComparable<Measurement>, IEquatable<Measurement>
    {
        ...
        public static Force.Measurement operator *(Measurement left, Area.Measurement right) => new(left.Value * right.Value);

        public static Energy.Measurement operator *(Measurement left, Volume.Measurement right) => new(left.Value * right.Value);
        #endregion
    }
}
